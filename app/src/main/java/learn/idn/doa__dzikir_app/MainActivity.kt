...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private lateinit var llSunnahQouLiyah: LinearLayout
    ...
    private fun initView() {
        llSunnahQouLiyah = findViewById(R.id.ll_sunnah_qouliyah)
        llSunnahQouLiyah.setOnClickListener(this)
    ...
    override fun onClick(view: View?) {
        when (view?.id) {
            R.id.ll_sunnah_qouliyah -> startActivity(
                Intent(
                    this,
                    QouliyahShalatActivity::class.java
                )
            )
